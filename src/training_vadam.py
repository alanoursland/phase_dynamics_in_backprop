...
optimizer_relu = Vadam(model_relu.parameters(), lr=learning_rate)
optimizer_abs = Vadam(model_abs.parameters(), lr=learning_rate)
optimizer_square = Vadam(model_square.parameters(), lr=learning_rate)
